...
from .views import (agendamento_pagar, AgendamentoView, AgendamentoAddView, AgendamentoUpdateView,
                    AgendamentoDeleteView, finalizar_agendamento, concluir_agendamento, )
